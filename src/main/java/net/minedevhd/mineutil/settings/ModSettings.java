...
public class ModSettings implements UtilCore {
    ...
    private String commandPrefix = ".",
    	    	   ...
    	    	   modGGGlobalchatWriterWebhook = "null",
    			   modRealMoney$real = "Real-Money",
    			   modRealMoney$fake = "Fake-Money",
    			   modAutojoinTargetCB = "CB1";
    ...
    private boolean modEnabled = true,
    				...
    				modGGAutoJoinCB = false,
    				modGGGlobalchatWriter = false,
...
//    private final String DEFAULT_PREFIX = "§6•§e● §6Mi§ene§6Ut§eil§8│§r ";
	...
	public final boolean isModMapPreview() {
		return this.modMapPreview;
	}

	public final void setModMapPreview(boolean modMapPreview) {
		this.modMapPreview = modMapPreview;
	}

	public final boolean isModGrieferWert() {
		return this.modGrieferWert;
	}

	public final void setModGrieferWert(boolean modGrieferWert) {
		this.modGrieferWert = modGrieferWert;
	}

	public final boolean isModGGAutoJoinCB() {
		return this.modGGAutoJoinCB;
	}

	public final void setModGGAutoJoinCB(boolean modGGAutoJoinCB) {
		this.modGGAutoJoinCB = modGGAutoJoinCB;
	}

	public final String getModAutojoinTargetCB() {
		return this.modAutojoinTargetCB;
	}

	public final void setModAutojoinTargetCB(String modAutojoinTargetCB) {
		this.modAutojoinTargetCB = modAutojoinTargetCB;
	}

	public final boolean isModGGGlobalchatWriter() {
		return this.modGGGlobalchatWriter;
	}

	public final void setModGGGlobalchatWriter(boolean modGGGlobalchatWriter) {
		this.modGGGlobalchatWriter = modGGGlobalchatWriter;
	}

	public final String getModGGGlobalchatWriterWebhook() {
		return this.modGGGlobalchatWriterWebhook;
	}

	public final void setModGGGlobalchatWriterWebhook(String modGGGlobalchatWriterWebhook) {
		this.modGGGlobalchatWriterWebhook = modGGGlobalchatWriterWebhook;
	}

	public void loadConfig() {
		PreisInfos.loadPriceConfig();
		
		this.modEnabled = (mineUtil.getConfig().has("modEnabled") ? mineUtil.getConfig().get("modEnabled").getAsBoolean() : true);
        ...
        this.modTrajectories = (mineUtil.getConfig().has("modTrajectories") ? mineUtil.getConfig().get("modTrajectories").getAsBoolean() : false);
        this.modMapPreview = (mineUtil.getConfig().has("modMapPreview") ? mineUtil.getConfig().get("modMapPreview").getAsBoolean() : false);
        this.modGrieferWert = (mineUtil.getConfig().has("modGrieferWert") ? mineUtil.getConfig().get("modGrieferWert").getAsBoolean() : false);
        this.modGGAutoJoinCB = (mineUtil.getConfig().has("modGGAutoJoinCB") ? mineUtil.getConfig().get("modGGAutoJoinCB").getAsBoolean() : false);
        this.modAutojoinTargetCB = (mineUtil.getConfig().has("autojoin_targetcb") ? mineUtil.getConfig().get("autojoin_targetcb").getAsString() : "CB1");
        this.modGGGlobalchatWriter = (mineUtil.getConfig().has("modGGGlobalchatWriter") ? mineUtil.getConfig().get("modGGGlobalchatWriter").getAsBoolean() : false);
        this.modGGGlobalchatWriterWebhook = (mineUtil.getConfig().has("modGGGlobalchatWriterWebhook") ? mineUtil.getConfig().get("modGGGlobalchatWriterWebhook").getAsString() : "null");
	}
    ...
    public void fillSettings(final List<SettingsElement> settings) {
        ...
        final KeyElement modHeadDLKeyElement = new KeyElement("Skin Download-Hotkey", new ControlElement.IconData("labymod/textures/settings/modules/online_players.png"), (int)this.getHeadDownloadKey(), new Consumer<Integer>() {
            public void accept(final Integer modHeadDLKey) {
                ...
                mineUtil.getConfig().addProperty("headDownloadKey", (Number) modHeadDLKey);
                mineUtil.saveConfig();
        ...
        final BooleanElement modMapPreview = new BooleanElement("Display Preview of Map in Tooltip", new ControlElement.IconData("labymod/textures/buttons/hover_default.png"), new Consumer<Boolean>() {
            public void accept(final Boolean val) {
                ModSettings.this.setModMapPreview(val);
                mineUtil.getConfig().addProperty("modMapPreview", val);
                mineUtil.saveConfig();
            }
        }, this.isModMapPreview());
        genCategory.getSubSettings().add(modMapPreview);
        ...
        final BooleanElement modGGGrieferWert = new BooleanElement("Show GrieferWert Infos", new ControlElement.IconData("labymod/addons/MineUtil/textures/grieferwert.png"), new Consumer<Boolean>() {
            public void accept(final Boolean modGW) {
                ModSettings.this.setModGrieferWert(modGW);
                mineUtil.getConfig().addProperty("modGrieferWert", modGW);
                mineUtil.saveConfig();
            }
        }, this.isModGrieferWert());
        ggCategory.getSubSettings().add(modGGGrieferWert);
        
        final BooleanElement modGGGlobalchatWriter = new BooleanElement("Write Globalchat-Msg into DC-Channel", new ControlElement.IconData("labymod/addons/MineUtil/textures/globalchat.jpg"), new Consumer<Boolean>() {
            public void accept(final Boolean modv) {
                ModSettings.this.setModGGGlobalchatWriter(modv);
                mineUtil.getConfig().addProperty("modGGGlobalchatWriter", modv);
                mineUtil.saveConfig();
            }
        }, this.isModGGGlobalchatWriter());
        ggCategory.getSubSettings().add(modGGGlobalchatWriter);
        
        StringElement dcWriterWebhookStringElement = new StringElement("Discord Webhook", new ControlElement.IconData("labymod/textures/settings/settings/discordrichpresence.png"), this.getModGGGlobalchatWriterWebhook()/*"null"*/, new Consumer<String>() {
            @Override
            public void accept(String accepted) {
            	ModSettings.this.setModGGGlobalchatWriterWebhook(accepted);
                mineUtil.getConfig().addProperty("modGGGlobalchatWriterWebhook", accepted);
                mineUtil.saveConfig();
            }
        });
        ggCategory.getSubSettings().add(dcWriterWebhookStringElement);
        
//        final BooleanElement modGGAutoJoinCB = new BooleanElement("Join the target citybuild automatically", new ControlElement.IconData("labymod/textures/settings/default/use_default_settings.png"), new Consumer<Boolean>() {
//            public void accept(final Boolean modVal) {
//                ModSettings.this.setModGGAutoJoinCB(modVal);
//                mineUtil.getConfig().addProperty("modGGAutoJoinCB", modVal);
//                mineUtil.saveConfig();
//            }
//        }, this.isModGGAutoJoinCB());
//        ggCategory.getSubSettings().add(modGGAutoJoinCB);
//        
//        final DropDownMenu<Citybuilds.DropDown> autoJoinMenu = new DropDownMenu<Citybuilds.DropDown>("Citybuild", 0, 0, 0, 0).fill(Citybuilds.DropDown.values());
//    	DropDownElement<Citybuilds.DropDown> autoJoinMod = new DropDownElement<Citybuilds.DropDown>("Citybuild", autoJoinMenu);
//    	autoJoinMenu.setSelected(Citybuilds.getTCB());
//    	autoJoinMod.setChangeListener(new Consumer<Citybuilds.DropDown>() {
//    		@Override
//    		public void accept(Citybuilds.DropDown alignment) {
//    			System.out.println("New selected alignment: " + alignment.name());
//    			Citybuilds.setDDCitybuildsValue(alignment);
//    		}
//    	} );
//    	autoJoinMenu.setEntryDrawer(new DropDownMenu.DropDownEntryDrawer() {
//    		@Override
//    		public void draw(Object object, int x, int y, String trimmedEntry) {
//    			String entry = object.toString().toUpperCase();
//    			LabyMod.getInstance().getDrawUtils().drawString(LanguageManager.translate(entry), x, y );
...
//    	} );
//    	//Citybuilds : End
//    	ggCategory.getSubSettings().add(autoJoinMod);
...
//        PreisInfos.fillPriceSettings(settings);
    ...
    public static class Citybuilds {
    	public static String ens = "CB1";
    	...
    	public static enum DropDown {
        	...
        	CB17, CB18, CB19, CB20, 
        	CB21, CB22, 
        	CBEVIL, NATURE, EXTREME;
        }
        
        public static void setDDCitybuildsValue(DropDown dropDownValue) {
        	ens = dropDownValue.name();
        	mineUtil.getConfig().addProperty("autojoin_targetcb", ens);
            mineUtil.saveConfig();
        }
        
        public static String getTargetCB() {
        	return ens;
        }
        
        public static String getTTCB() {
        	return mineUtil.getConfig().get("autojoin_targetcb").getAsString();
        }
        
        public static DropDown getTCB() {
        	return DropDown.valueOf(getTargetCB());
        }
    }
