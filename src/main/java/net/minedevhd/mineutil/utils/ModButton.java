    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if(this.visible) {
			...
			case 2: {
				...
				GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
				GlStateManager.blendFunc(770, 771);
				Gui.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, new Color(40, 81, 137).getRGB());
				this.mouseDragged(mc, mouseX, mouseY);
				j = 14737632;
				...
				if(!this.enabled) {
                	...
                	if(this.hovered) {
                		j = 16777120;
        				Gui.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, new Color(60, 118, 198).getRGB());
                	}
				break;
			}
			case 3: {
                ...
                int color = new Color(40, 81, 137, 220).getRGB();
                if(this.buttonDesign == 1) {
    	            this.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, new Color(0, 0, 0, 110).getRGB());
    	            this.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.animatedHeight, new Color(255, 255, 255, 85).getRGB());
                }
                ...
                if(!this.enabled) {
                	...
                	if(this.hovered) {
                		j = 16777120;
                		color = new Color(60, 118, 198, 220).getRGB();
                	}
                if(buttonDesign == 0) {
                	RenderUtils.drawRoundedRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 20, color);
                }
