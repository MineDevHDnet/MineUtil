...
public class Give extends Command {
	...
	public void onCommand(String[] args, String command) {
		if(args.length == 1) {
			final EntityPlayerSP ep = mineUtil.getMCCore().thePlayer;
			final boolean creative = mineUtil.getMCCore().playerController.isInCreativeMode();
			...
			if(creative) {
				...
				LabyMod.getInstance().displayMessageInChat(MineUtil.getUtilCore().getSettings().getPrefix() + "§fLook at your shoes...");
			}
			else {
