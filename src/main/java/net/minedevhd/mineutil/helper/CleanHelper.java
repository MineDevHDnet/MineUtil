...
public class CleanHelper implements UtilCore {
	
	private TimeHelper time = new TimeHelper();
	
	public void clean(final EntityPlayerSP player, final PlayerControllerMP playerCtrl, final Container container) {
