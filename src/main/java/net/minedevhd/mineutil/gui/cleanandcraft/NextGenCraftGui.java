...
public class NextGenCraftGui extends GuiScreen implements UtilCore {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		DrawUtil.drawSizedString(this, "NextGen - Crafting", -1, 5, true, MineUtil.CLIENT_COLOR);
