...
public class CleanCraftPrismarineGui extends GuiScreen implements UtilCore {

    GuiButton cleanSpawnerButton,
    		  cleanChestInventoryButton,
    		  
    		  craftPrismarineButton,
    		  craftPrismarineBrickButton,
    		  craftDarkPrismarineButton,
    		  craftSeaLanternButton,
    		  craftSnowBlockButton,
    ...
    */
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    	...
    	mineUtil.getSettings().setCurrentGuiPage(6);
    ...
    public void initGui() {
    	...
    	/** Cat. Crafting */
    	this.buttonList.add(this.craftPrismarineButton = new ModButton(300, ModButton.API.getButtonXPos(1, this.width), ModButton.API.getButtonYPos(5), ModButton.API.getButtonWidth(), ModButton.API.getButtonHeight(), "Prismarine: OFF"));
    	this.buttonList.add(this.craftPrismarineBrickButton = new ModButton(310, ModButton.API.getButtonXPos(2, this.width), ModButton.API.getButtonYPos(5), ModButton.API.getButtonWidth(), ModButton.API.getButtonHeight(), "PrismarineBrick: OFF"));
    	this.buttonList.add(this.craftDarkPrismarineButton = new ModButton(320, ModButton.API.getButtonXPos(3, this.width), ModButton.API.getButtonYPos(5), ModButton.API.getButtonWidth(), ModButton.API.getButtonHeight(), "DarkPrismarine: OFF"));
    	this.buttonList.add(this.craftSeaLanternButton = new ModButton(330, ModButton.API.getButtonXPos(4, this.width), ModButton.API.getButtonYPos(5), ModButton.API.getButtonWidth(), ModButton.API.getButtonHeight(), "SeaLantern: OFF"));

    	this.buttonList.add(this.craftSnowBlockButton = new ModButton(340, ModButton.API.getButtonXPos(1, this.width), ModButton.API.getButtonYPos(6), ModButton.API.getButtonWidth(), ModButton.API.getButtonHeight(), "SnowBlock: OFF"));
