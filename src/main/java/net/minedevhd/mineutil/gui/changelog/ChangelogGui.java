...
public class ChangelogGui extends GuiScreen implements UtilCore
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
    	...
    	final String date = MineUtil.getCore().getChangelogDate();
		...
		final String commandPrefix = MineUtil.getCore().getSettings().getCommandPrefix();
